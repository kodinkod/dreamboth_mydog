...
Сначала я обучал модель, потом делал 4 генерации "A <rare-token> dog" с разным random seed, а затем генерирвал 4 картинки тестовые для проверки возможностей:
