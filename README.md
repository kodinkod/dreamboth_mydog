...
датасеты: в папке datasets, если хотите повторить мои исследование, закиньте их к себе на гугл диск или сделайте git clone моего репозитоерия себе в колаб и возьмите датасеты с datasets;
[run in colab](https://colab.research.google.com/drive/1KAM4otIc21EJNqKrRCr-Bvg_akgvbKs-?usp=share_link)
